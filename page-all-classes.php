...
<section class="py-0 sm:py-16">
  <div class="container px-3 sm:px-0 mx-auto">
    <div class="flex flex-wrap -mx-3 sm:-mx-8">
      ...
      <div class="w-full sm:w-9/12 mt-6 sm:mt-0 px-6 sm:px-8">
        ...
        <div class="flex flex-wrap -mx-3 sm:-mx-4">
          <?php get_template_part('template-parts/content', 'single-courses'); ?>
          <?php get_template_part('template-parts/content', 'combo-courses'); ?>
